...
| **Sprint 4 (Active)** | **MinIO Integration & OCR Asset Registration** | MinIO S3 object storage configurations, multipart document ingestion APIs, optical character recognition background parsing workers, and automated hardware manifest-to-database registration logic. |
